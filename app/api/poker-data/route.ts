...
export async function POST(request: Request) {
  ...
  if (!Array.isArray(data) || data.some(entry => !entry.bearo || typeof entry.games !== 'number' || typeof entry.wins !== 'number' || typeof entry.points !== 'number')) {
  ...
  try {
    ...
    console.error('Error updating Poker data:', error)
