...
const sections = [
  {
    ...
    records: [
      ...
      <><UnderlinedPlayer name="Vanilla" /> holds the highest win rate for a team in a season (Newcastle, Marseille) – 89.29%, 2023/24</>,
      ...
      <><UnderlinedPlayer name="Vanilla" /> was the first to score a goal from their own half (into an empty net, no lags), 2017 for Napoli</>,
      <><UnderlinedPlayer name="Vanilla" /> was the first to score an Olympic goal (directly from a corner) against an opponent (Lille), 2021/22</>,
      <><UnderlinedPlayer name="Vanilla" /> holds the longest unbeaten streak for a team (Barcelona) – 26 matches, 2023/24</>
    ]
  },
  {
    title: "FPL",
  ...
  },
  {
    ...
    records: [
      ...
      <><UnderlinedPlayer name="Vanilla" /> holds the record for most correctly predicted scores in a day – 4/5 matches, 2016</>
    ]
  },
  {
    title: "Geo Guessr",
    records: [
      ...
      <><UnderlinedPlayer name="Vanilla" /> struck the most 5K's in a season - 9, 2024/25 </>,
  ...
  },
  {
    ...
    records: [
      ...
      <><UnderlinedPlayer name="Panda" /> was the first to win 100 games in the club: it took him only 263 games, 09.06.2017</>,
