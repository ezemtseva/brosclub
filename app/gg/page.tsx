...
export default async function GGPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-base text-gray-600 mb-8">The first ever season includes five rounds for every game: move, no move and panorama (frozen). The player that hits 5K gets additional points.</p>
